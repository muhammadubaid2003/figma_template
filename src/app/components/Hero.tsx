...
const Hero = () => {
  ...
  <div className='flex flex-wrap justify-center gap-32'>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo.png"/>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo 1.png"/>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo 2.png"/>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo 3.png"/>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo 4.png"/>
    <Image alt="" className="object-cover object-center w-[85px] h-[87px]" src="/Logo 5.png"/>
  </div>
      </section>
