      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-10">
        ...
        <div className="w-full md:w-3/5">
          ...
          <div className="flex flex-col gap-6">
            {/* Product Item */}
            <div className="flex flex-col md:flex-row items-center md:justify-between p-4 bg-white shadow-md rounded-lg">
        ...
        {/* Summary Section */}
        <div className="w-full md:w-1/3 flex flex-col justify-start gap-6 bg-white shadow-md rounded-lg p-6">
          <h1 className="text-2xl md:text-3xl font-bold mb-4">Summary</h1>
